...
function Index() {
	...
	return (
		<IndexPageWrapper>
			<FilterContainer>
				<LinkButton onClick={() => handleFilterChange('all')} active={filter === 'all'}>
					All
				</LinkButton>
				<LinkButton onClick={() => handleFilterChange('projects')} active={filter === 'projects'}>
					Projects
				</LinkButton>
				<LinkButton onClick={() => handleFilterChange('articles')} active={filter === 'articles'}>
					Articles
				</LinkButton>
			</FilterContainer>
